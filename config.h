...
#define HEIGHT                 "500"                              // the height of the window
#define FONT                   "JetBrainsMono NFM Medium,\
                                DejaVuSansM Nerd Font Propo"      // Font(s) family
#define FONT_SIZE              11                                 // Font size 
...
#define TOGGLEFULLSCREEN       GDK_KEY_f
// Colors scheme
